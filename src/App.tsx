...
import { Admin, NotFound, Home, MassRegistration, Perfil, RequestRegistration, Reassign, Following, FollowingHistory, EvaluateFinalVisit, Assign } from "./pages/RoutesIndex";
