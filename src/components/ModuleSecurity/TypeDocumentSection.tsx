...
const TypeDocumentSection = () => {
	...
	const handleConfirm = async () => {
			try {
				...
				alert(e.message || "Error al crear tipo de documento");
			}
	};
	...
	const handleConfirmEdit = async () => {
			try {
				...
				alert(e.message || "Error al actualizar tipo de documento");
			}
	};
	...
	const handleConfirmDisable = async () => {
					try {
						...
						alert(e.message || "Error al deshabilitar tipo de documento");
					}
	};
